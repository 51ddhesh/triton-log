...
Paper - ["Layer Normalization"](https://arxiv.org/abs/1607.06450) - Jimmy Lei Ba, Jamie Ryan Kiros, Geoffrey E. Hinton

### The Forward Pass

The `LayerNorm` operator was introduced to improve the performance of sequential models like Transformers or Neural Networks with small batch size.

The forward pass in a `LayerNorm` is given as:
